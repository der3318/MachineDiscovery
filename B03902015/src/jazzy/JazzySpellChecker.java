...
public class JazzySpellChecker implements SpellCheckListener {
	...
	JazzySpellChecker(String _dicPath) {
		dicPath = _dicPath;
	...
	public static JazzySpellChecker getInstance(String _dicPath) {
		if( instance == null || !instance.dicPath.equals(_dicPath) )	instance = new JazzySpellChecker(_dicPath);
		return instance;
	}
